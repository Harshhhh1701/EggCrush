...
const Hero = () => {
    return (
        <div  className="bg-white h-screen flex flex-col justify-center items-center">
            <motion.h1 initial={{opacity:0}} animate={{fontSize:50,color:'#ff2994',x:100,y:-100,opacity:1}} transition={{delay:1.5,duration:1.5,type:'spring',stiffness:120}} className="lg:text-9xl md:text-7xl sm:text-5xl text-3xl font-black mb-14">
                EGGCELLENT
            </motion.h1>
